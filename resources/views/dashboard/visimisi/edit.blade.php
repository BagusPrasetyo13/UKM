    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="col-lg-8 ml-2">
                <form method="POST" action="/dashboard/visimisi/{{ $visimisi->id }}">
                    @method('put')
                    @csrf
                     <div class="form-group">
                        <label for="periode">Periode</label>
                        <input type="text" class="form-control @error('periode') is-invalid @enderror"
                         id="periode" name="periode" autofocus value="{{ $visimisi->periode }}">
                         @error('periode')
                    ...
                    <div class="form-group">
                        ...
                        <input id="visi"  type="hidden" name="visi" value="{{ $visimisi->visi }}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="misi"  type="hidden" name="misi" value="{{ $visimisi->misi }}">
